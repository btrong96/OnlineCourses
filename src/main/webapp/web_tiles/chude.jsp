...
<head>
<meta charset="UTF-8">
<title>Các Chủ Đề Khóa Học</title>
...
<s:set var="chuDeKhoaHoc" value="abc" />
<s:if test='#session.containsKey("chuDeKhoaHoc")'>
	<s:set var="chuDeKhoaHoc" value='#session["chuDeKhoaHoc"]' />
</s:if>
...
<div class="container-fluid bn">
 ...
 <s:if test=" #chuDeKhoaHoc == all">	
  <div class="container">	
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h3 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Chủ Đề Khóa Học</h3>		
  </div>	

  		
		<div class="row">		
		<s:iterator value="lstChuDe">						
		<div class="col-md-3 filter creative">
				<div class="thumbnail">										
					<img class="wow bounceInRight" data-wow-duration="2s"
						src="images/<s:property value='anhDaiDien' />"   width="500" height="250"  alt="Lights">						
					<div class="caption wow bounceInRight" data-wow-duration="2.5s">
					
						<a href='<s:url action="layKhoaHocTheoChuDe?ma=%{id}"/>' target="#">  <h5> <s:property value="tenChuDe" /> </h5>  </a>
						<p><s:property value="moTa" /></p>						
						<a href='<s:url action="layKhoaHocTheoChuDe?ma=%{id}"/>' target="#"><p>
  ...
  <s:if test=" #chuDeKhoaHoc == chuDeTheoLoai">	
  <div class="container">	
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h3 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Chủ Đề Khóa Học Theo Loại: <s:property value="tenLoai" /> </h3>		
  </div>			
		<div class="row">		
		<s:iterator value="lstChuDeTimKiemTheoLoai">						
		<div class="col-md-3 filter creative">
				<div class="thumbnail">										
					<img class="wow bounceInRight" data-wow-duration="2s"
	...
	<div class="container">
		...
		<s:iterator value="lstLoai">
			<div class="col-xl-3 col-lg-3 col-md-6 wow bounceInRight">				
				...
				<a href='<s:url action="chiTietSach?ma=%{id}"/>'><h5><s:property value="tenLoai" /></h5></a>
				<p><s:property value="moTa" /></p>													  							
			</div>			
      </s:iterator>			
		</div>
