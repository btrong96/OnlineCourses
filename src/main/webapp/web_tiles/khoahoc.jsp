...
<s:set var="khoaHoc" value="abc" />
<s:if test='#session.containsKey("khoaHoc")'>
	<s:set var="khoaHoc" value='#session["khoaHoc"]' />
</s:if>
...
<div class="container-fluid sm">
		...
		<p id="x">&nbsp;/&nbsp;</p>
		<a id="abu" href="hinhAnh.html">Khóa Học</a>
	</div>
	...
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
	 ...
	 <s:if test=" #khoaHoc == khoaHocTheoChuDe">
	<div class="container cachbot">
	
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h1 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Danh Sách Khóa Học Thuộc Chủ Đề <s:property value="tenChuDe" /></h1>		
    </div>
	
		<div class="row">
			<s:iterator value="lstKhoaHocTimKiemTheoChuDe">			
	 ...
	 <s:if test=" #khoaHoc == khoaHocTheoCapDo">
	<div class="container cachbot">
	
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h1 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Danh Sách Khóa Học Thuộc Cấp Độ <s:property value="tenCapDo" /></h1>		
    </div>
	
		<div class="row">
			<s:iterator value="lstKhoaHocTimKiemTheoCapDo">			
