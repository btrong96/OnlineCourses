...
<div class="container-fluid sm">
	...
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h1 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Danh Sách Bài Giảng</h1>		
    </div>
	...
	<div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
	 ...
	 <!-- CÓ PHÍ (CẢ ĐĂNG KÝ LẪN CHƯA ĐĂNG KÝ) -->
	 <div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		<h3 id="cpn" class="wow bounceInDown" data-wow-duration="2s">Danh Sách Bài Giảng Có Phí</h3>		
    </div>
	 <s:iterator value="lstBaiGiangCoPhi">			
			...
			<div class="col-md-3 filter creative">
				<div class="thumbnail">										
					...
					<div class="caption wow bounceInRight" data-wow-duration="2.5s">
						...
						<s:if test=" #username == true">						 								                
					<!--	<a href='<s:url action="baigiang"/>' target="#"><p>
								<i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View
							</p></a>	 -->						            
			            </s:if>	
	  ...
	  <div style="width: 100%; text-align: center; margin-top: 40px; margin-bottom: 30px;" >			
		...
		<s:iterator value="lstBGtheoKHcoPhiCoDANGKYFULL">		
